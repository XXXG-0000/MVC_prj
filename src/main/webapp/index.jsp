...
<!-- HTML 영역 => HTML 태그 작성, CSS 정의한 디자인 적용, JS에서 동적인 디자인 생성 보여주는 일, JS에서 HTML Form Control에 입력된 값을 
	...
	<!-- forward 요청 -->
	<a href="main_controller.do?cmd=M001">메인화면</a>
	<a href="book_list.do?cmd=B001">교재 리스트</a>
	<!-- redirect -->
	<a href="redirect.do?cmd=R001">redirect 요청</a>
	<a href="search_dept.do?cmd=S001">부서 조회</a>
